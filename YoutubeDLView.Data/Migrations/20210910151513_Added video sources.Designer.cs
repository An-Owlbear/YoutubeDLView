...
namespace YoutubeDLView.Data.Migrations
{
    ...
    [Migration("20210910151513_Added video sources")]
    partial class Addedvideosources
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("YoutubeDLView.Core.Entities.VideoSource", b =>
                {
                    b.Property<string>("Path")
                        .HasColumnType("TEXT");
            ...
            modelBuilder.Entity("YoutubeDLView.Core.Entities.YtChannel", b =>
                {
                    b.Property<string>("Id")
                        .HasColumnType("TEXT");
            ...
            modelBuilder.Entity("YoutubeDLView.Core.Entities.Video", b =>
                {
                    b.HasOne("YoutubeDLView.Core.Entities.YtChannel", "Channel")
                        .WithMany("Videos")
